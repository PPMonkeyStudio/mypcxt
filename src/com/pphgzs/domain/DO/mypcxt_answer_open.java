...
public class mypcxt_answer_open {
	private String mypcxt_answer_open_id;
	...
	public String toString() {
		return "mypcxt_answer_open [\nmypcxt_answer_open_id=" + mypcxt_answer_open_id
	...
	public String getMypcxt_answer_open_id() {
		return mypcxt_answer_open_id;
	}

	public void setMypcxt_answer_open_id(String mypcxt_answer_open_id) {
		this.mypcxt_answer_open_id = mypcxt_answer_open_id;
	}
