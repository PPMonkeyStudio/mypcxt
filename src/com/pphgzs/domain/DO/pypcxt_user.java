...
public class pypcxt_user {
	private String pypcxt_user_id;
	...
	public String getPypcxt_user_id() {
		return pypcxt_user_id;
	}

	public void setPypcxt_user_id(String pypcxt_user_id) {
		this.pypcxt_user_id = pypcxt_user_id;
	}
